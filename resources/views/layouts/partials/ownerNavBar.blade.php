    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/"><img src="Assets/images/Logo Aira.png" class="logo" alt=""></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                    ...
                    <li class="{{ ($title === "Product_List") ? 'nav-item active' : 'nav-item'}}"><a class="nav-link" href="">Product List</a></li>
                    <li class="{{ ($title === "Customer_Order") ? 'nav-item active' : 'nav-item'}}"><a class="nav-link" href="">Customer Order</a></li>
                    <li class="{{ ($title === "Transaction") ? 'nav-item active' : 'nav-item'}}"><a class="nav-link" href="">Transaction</a></li>
